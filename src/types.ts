...
export type FeatureEnqueuer = {enqueue: (feature:Feature) => void}
export type PropertiesEnqueuer = {enqueue: (properties:Properties) => void}
export type FeatureLocation = { offset: number, length: number}
...
export declare namespace GeoJSON {
    ...
    export interface Feature {
        ...
        /**
         * added for parsing purpose
         */
        _location?: FeatureLocation
    }
